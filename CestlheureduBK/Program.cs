...
app.MapPut(
    "api/energy/{productId}",
    async (string productId, [FromServices] UpdateDataService updateDataService) =>
    {
        return Results.Ok(await updateDataService.ReloadEnergy(productId));
    }
);
