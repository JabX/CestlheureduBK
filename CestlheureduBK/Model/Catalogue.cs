...
public record Game(int Id, int Algo, double Price, string SysName, bool Available, bool Active, bool EarnPoints, int Vatpc);

public record Ingredient(string Id, string Name, string Description, bool CampaignItem, bool WithPrice, string Plu, double Price, string Image, bool Available, bool Active, string[]? Allergens);
...
public record Product(bool Active, string? AirshipTagInApp, string[] Allergens, bool Available, bool CampaignItem, CategorieCategorie[]? Categories, bool Composable, bool Configurable, string Description, bool EarnPoints, bool HasBacon, bool HasIce, string Id, string Image, ProductIngredient[] Ingredients, bool IsComposable, bool IsProductGroup, Dictionary<int, int> MaxCountByOptionType, int? MaxQuantity, double MenuExtraPriceTTC, string Name, bool NoWeb, ProductOption[] Options, bool PickupLater, string Plu, double Price, bool ProductGroup, string? ProductGroupId, string RouteId, string[]? SubCategories, string[] SuggestionsIds, string? UpperSizeProductId);

public record Promotion(string Code, string Description, string Id, string IdReboot, string Label, double? MaxPriceToApply, string[] MenuIds, double? MinPriceToApply, string Name, string[] ProductIds, string? PromoRuleClassname, string? PromoRuleScript, string PromoType, double? PromoValue, string[] RequiredMenuIds, string[] RequiredProductIds, double? Threshold);